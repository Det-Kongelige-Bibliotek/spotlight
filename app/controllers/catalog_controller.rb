...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    #   The ordering of the field names is the order of the display
    config.add_index_field 'subtitle_tesim', :label => 'Undertitel'
    config.add_index_field 'author_tesim', :label => 'Forfatter'
    config.add_index_field 'person_name_tesim', :label => 'Navn'

    # solr fields to be displayed in the show (single result) view
    #   The ordering of the field names is the order of the display
    config.add_show_field 'subtitle_tesim', :label => 'Undertitel'
    config.add_show_field 'author_tesim', :label => 'Forfatter'
    config.add_show_field 'person_name_tesim', :label => 'Navn'
